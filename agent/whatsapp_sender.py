...
def send_whatsapp(
    ...
    Args:
        ...
        content_sid (Optional[str]): Twilio Content Template SID (e.g. HXb5b62575e6e4ff6129ad7c8efe1f983e).
        content_variables (Optional[str]): JSON string representing the template parameters.
    """
    ...
    try:
        ...
        if content_sid:
            logger.info(f"  Using Content Template SID: {content_sid}")
